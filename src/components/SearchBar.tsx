...
const CreateBar = ({ placeholder, disabled = false }: CreateBarProps) => {
  return (
    <div className="flex flex-row justify-between items-center gap-0 w-full rounded-xl border border-gray-200 shadow-sm shadow-gray-100 font-light bg-white px-4 ">
